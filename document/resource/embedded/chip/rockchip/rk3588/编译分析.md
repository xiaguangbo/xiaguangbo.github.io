...
```
615 build_uboot()
    633：make rk3588_defconfig firefly-linux.config
    639：./make.sh CROSS_COMPILE=/root/sdk_linux/rk3588/prebuilts/gcc/linux-x86/aarch64/gcc-arm-10.3-2021.07-x86_64-aarch64-none-linux-gnu/bin/aarch64-none-linux-gnu-
```