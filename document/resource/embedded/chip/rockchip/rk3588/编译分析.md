...
MiniLoaderAll.bin 的位置可能是在 0x40
...
可以通过同时删除 parameter-ubuntu-fit.txt 和 rk3588-ubuntu-package-file 相似的一部分简化镜像

去掉 misc、recovery、backup 无影响
...
MiniLoaderAll.bin = rkbin/rk3588_spl_loader_v1.08.111.bin：// 自带

uboot.img = u-boot/fit/uboot.itb：
    bl31_0x00040000、bl31_0x000f0000、bl31_0xff100000 // 自带
    tee.bin // 自带
