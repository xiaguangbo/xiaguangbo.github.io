...
```
有两个同名的，原作者是 HandyOrg，另一个是 Mahdi Hosseini，后者是别的作者根据原来的再自定义的

步骤1：添加对HandyControls的引用或在nuget上搜索HandyControls;

Install-Package HandyControls

步骤 2：在 App.xaml 中添加代码，如下所示：
...
第 3 步：添加命名空间：xmlns:hc="https://handyorg.github.io/handycontrol"
